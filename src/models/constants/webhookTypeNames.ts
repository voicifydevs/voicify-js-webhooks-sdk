export const webhookTypeNames = {
     ...
     CONTENT_ITEM_SAVED_EVENT : "Content Item Saved Event",
     FEATURE_MISS_EVENT : "Feature Miss Event",
     CONTENT_MISS_EVENT : "Content Miss Event",
     CONTENT_HIT_EVENT : "Content Hit Event",
     REQUEST_RECEIVED_EVENT : "Request Received Event",
